...
export default {
  ...
  // Guest photowall (#138)
  "wedding.photowall.eyebrow": "照片牆",
  "wedding.photowall.title": "賓客的精彩瞬間",
  "wedding.photowall.empty": "還沒有照片——快來分享第一張吧！",
  "wedding.photowall.addPhoto": "分享照片",
  "wedding.photowall.pinLabel": "照片牆 PIN 碼",
  "wedding.photowall.pinPlaceholder": "邀請函上的 PIN 碼",
  "wedding.photowall.nameLabel": "您的名字",
  "wedding.photowall.captionLabel": "說明文字",
  "wedding.photowall.optional": "選填",
  "wedding.photowall.submit": "上傳照片",
  "wedding.photowall.preparing": "正在處理照片…",
  "wedding.photowall.uploading": "上傳中…",
  "wedding.photowall.success": "謝謝您！您的照片已加入照片牆 🎉",
  "wedding.photowall.demoNotice": "示範模式——照片分享功能已停用。",
  "wedding.photowall.sharedBy": "由 {name} 分享",
  "wedding.photowall.err.pinInvalid": "PIN 碼不正確——請核對您的邀請函。",
  "wedding.photowall.err.tooManyAttempts": "嘗試次數過多——請幾分鐘後再試。",
  "wedding.photowall.err.disabled": "照片分享目前未開放。",
  "wedding.photowall.err.full": "照片牆已滿——感謝大家！",
  "wedding.photowall.err.tooLarge": "照片檔案太大，無法上傳。",
  "wedding.photowall.err.badType": "請選擇 JPG、PNG 或 WebP 格式的照片。",
  "wedding.photowall.err.unsupported": "您的瀏覽器不支援此照片格式——請改用其他照片。",
  "wedding.photowall.err.uploadFailed": "上傳未完成——請再試一次。",
  "wedding.photowall.err.generic": "發生錯誤——請再試一次。",
