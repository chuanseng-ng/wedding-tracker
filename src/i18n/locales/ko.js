...
export default {
  ...
  // Guest photowall (#138)
  "wedding.photowall.eyebrow": "포토월",
  "wedding.photowall.title": "하객들이 담은 순간",
  "wedding.photowall.empty": "아직 사진이 없어요 — 첫 번째로 공유해 보세요!",
  "wedding.photowall.addPhoto": "사진 공유하기",
  "wedding.photowall.pinLabel": "포토월 PIN",
  "wedding.photowall.pinPlaceholder": "청첩장에 적힌 PIN",
  "wedding.photowall.nameLabel": "이름",
  "wedding.photowall.captionLabel": "설명",
  "wedding.photowall.optional": "선택 사항",
  "wedding.photowall.submit": "사진 올리기",
  "wedding.photowall.preparing": "사진 준비 중…",
  "wedding.photowall.uploading": "업로드 중…",
  "wedding.photowall.success": "감사합니다! 사진이 포토월에 올라갔어요 🎉",
  "wedding.photowall.demoNotice": "데모 모드 — 사진 공유가 비활성화되어 있습니다.",
  "wedding.photowall.sharedBy": "{name} 님이 공유",
  "wedding.photowall.err.pinInvalid": "PIN이 일치하지 않아요 — 청첩장을 확인해 주세요.",
  "wedding.photowall.err.tooManyAttempts": "시도 횟수가 너무 많아요 — 몇 분 후 다시 시도해 주세요.",
  "wedding.photowall.err.disabled": "지금은 사진 공유가 열려 있지 않아요.",
  "wedding.photowall.err.full": "포토월이 가득 찼어요 — 모두 감사합니다!",
  "wedding.photowall.err.tooLarge": "사진이 너무 커서 올릴 수 없어요.",
  "wedding.photowall.err.badType": "JPG, PNG 또는 WebP 사진을 선택해 주세요.",
  "wedding.photowall.err.unsupported": "이 사진 형식은 사용 중인 브라우저에서 지원되지 않아요 — 다른 사진을 시도해 주세요.",
  "wedding.photowall.err.uploadFailed": "업로드가 완료되지 않았어요 — 다시 시도해 주세요.",
  "wedding.photowall.err.generic": "문제가 발생했어요 — 다시 시도해 주세요.",
