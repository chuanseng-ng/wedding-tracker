...
export default {
  ...
  // Guest photowall (#138)
  "wedding.photowall.eyebrow": "フォトウォール",
  "wedding.photowall.title": "ゲストの皆さまの一枚",
  "wedding.photowall.empty": "まだ写真がありません——最初の一枚をぜひ！",
  "wedding.photowall.addPhoto": "写真をシェア",
  "wedding.photowall.pinLabel": "フォトウォールPIN",
  "wedding.photowall.pinPlaceholder": "招待状に記載のPIN",
  "wedding.photowall.nameLabel": "お名前",
  "wedding.photowall.captionLabel": "キャプション",
  "wedding.photowall.optional": "任意",
  "wedding.photowall.submit": "写真をアップロード",
  "wedding.photowall.preparing": "写真を準備中…",
  "wedding.photowall.uploading": "アップロード中…",
  "wedding.photowall.success": "ありがとうございます！写真がフォトウォールに追加されました 🎉",
  "wedding.photowall.demoNotice": "デモモード——写真の共有は無効です。",
  "wedding.photowall.sharedBy": "{name} さんより",
  "wedding.photowall.err.pinInvalid": "PINが一致しません——招待状をご確認ください。",
  "wedding.photowall.err.tooManyAttempts": "試行回数が多すぎます——数分後にもう一度お試しください。",
  "wedding.photowall.err.disabled": "現在、写真の共有は受け付けていません。",
  "wedding.photowall.err.full": "フォトウォールが満杯です——皆さまありがとうございます！",
  "wedding.photowall.err.tooLarge": "写真のサイズが大きすぎます。",
  "wedding.photowall.err.badType": "JPG、PNG、WebP形式の写真を選んでください。",
  "wedding.photowall.err.unsupported": "お使いのブラウザはこの写真形式に対応していません——別の写真をお試しください。",
  "wedding.photowall.err.uploadFailed": "アップロードが完了しませんでした——もう一度お試しください。",
  "wedding.photowall.err.generic": "エラーが発生しました——もう一度お試しください。",
